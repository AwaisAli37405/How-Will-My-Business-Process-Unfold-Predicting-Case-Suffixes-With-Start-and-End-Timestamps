...
# =============================================================================
    ...
    next_event = Input(shape=(train_vec['prefixes']['next_evt_start'].shape[1],), name='next_event')
...
# =============================================================================
    ...
    next_event_reshaped = Reshape((train_vec['prefixes']['next_evt_start'].shape[1], 1))(next_event)
# =============================================================================
#    Layer 1
# =============================================================================
    concatenate = Concatenate(name='concatenated', axis=2)([ac_embedding, rl_embedding,next_event_reshaped, t_input])
...
# =============================================================================
    ...
    model = Model(inputs=[ac_input, rl_input,next_event, t_input],
                  outputs=[ time_output])
    ...
    print(train_vec['next_evt']['activities'].shape)
    print(train_vec['next_evt']['roles'].shape)
    print(train_vec['next_evt']['times'].shape)
